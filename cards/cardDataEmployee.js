...
import ModalDetailDataEmployee from "../modal_details/modalDetailDataEmployee";
// import ModalEditPrinciple from "../modal_edit/modalEditPrinciple";

export default class CardDataEmployee extends Component {
  constructor(props) {
    super(props);
    this.state = {
